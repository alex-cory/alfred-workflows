...
require 'find'
require 'shellwords'
load "alfred_feedback_copy.rb"
load "config_copy.rb"
load "download_progress_copy.rb"

$config = RDW::Config.new

Data_File = File.expand_path "recent_downloads_copy.txt", RDW::Config::VOLATILE_DIR

# -------------------------------------------------------------
# -------------------------------------------------------------
# -------------------CHANGE THIS FILE PATH---------------------
# ---------------------|--------------|------------------------
DIR = File.expand_path "~/Library/Application Support/Alfred 2/Alfred.alfredpreferences/workflows" # CHANGE THIS FILE PATH
# -------------------------------------------------------------
# -------------------------------------------------------------
# -------------------------------------------------------------
# recent_downloads.rb --- Line: 16
# installSoftware.sh  --- Line: 245
# config.rb           --- Line: 33
# -------------------------------------------------------------
# -------------------------------------------------------------
# -------------------------------------------------------------
